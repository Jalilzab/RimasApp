...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private EditText inputName, inputAddress, inputCity, inputState, inputPhoneNum,inputCardNumber, inputCardExpiry, inputCardPin ;
        ...
        switchDelivery.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked) {
                    ...
                    inputPhoneNum.setVisibility(View.VISIBLE);
    ...
    private void onPlaceOrderButtonClick(RestaurantModel restaurantModel) {
        if(TextUtils.isEmpty(inputName.getText().toString())) {
            ...
            inputState.setError("Please enter phone number(including Area Code..ie 501");
            return;
